                ...
                <Grid>
                    <Grid.Row>
                        ...
                        <Grid.Column mobile={16} tablet={12} computer={10}>
                            <DvTitleSmall fz='28' asButton xsCenter onClick={this.open}>Change Password</DvTitleSmall>
                        </Grid.Column>
                    </Grid.Row>
                    <Transition visible={opened} animation='fade down' duration={500} unmountOnHide={true}>
                        <Grid.Row>
