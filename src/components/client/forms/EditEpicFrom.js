...
class EditEpicForm extends Component {
    ...
    fillFields = data => {
        let { description, user_story, deliverables, business_requirements, notes, business_rules } = data;
        ...
        this.props.dispatch(change('EditEpicForm', 'requirements',   business_requirements));
