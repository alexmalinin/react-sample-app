        ...
        <Container indentBot>
          <StyledSpecialistWelcomeForm2>
            <div className="half-column">
              <DvTitle mTop="80">Thanks for joining The Village!</DvTitle>
              ...
              <p>
                ...
                call to discuss in detail about your experience and to also
                understand how we can support you further to get the most out of
                this platform.
              </p>
            </div>
...
export default connect(
  ({ signUpData, educations, experiences }) => ({
    signUpData,
    educations,
    experiences
  }),
