    ...
    return (
      <div>
        ...
        <Container indentBot>
          ...
          />
          {confirm && (
            <Redirect to="/specialists/dashboard/welcome-to-the-village-2" />
          )}
        </Container>
      </div>
    );
...
export default connect(
  ({ industries, signUpData }) => ({ industries, signUpData }),
  { getIndustries, updateSpecStep1 }
)(confirm(SpecialistsWelcome1));
